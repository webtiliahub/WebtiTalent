  ...
  return (
    <main style={{ minHeight: '100dvh', display: 'grid', placeItems: 'center', background: '#f7f5f2', padding: '0 24px', textAlign: 'center', fontFamily: 'Arial, Helvetica, sans-serif' }}>
      <div>
        ...
        <img src="/logo/webtilia-iso.png" alt="Webtilia" style={{ margin: '0 auto', height: 48, objectFit: 'contain', display: 'block' }} />
        ...
        <a href="/" style={{ marginTop: 20, display: 'inline-block', background: '#0067ff', color: '#ffffff', padding: '10px 20px', borderRadius: 12, fontSize: 14, fontWeight: 700, textDecoration: 'none' }}>Reintentar</a>
      </div>
    </main>
  )
}
