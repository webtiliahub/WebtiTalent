...
export type RateLimitWhereInput = {
  ...
  clave?: Prisma.StringFilter<"RateLimit"> | string
  hits?: Prisma.IntFilter<"RateLimit"> | number
  reinicia?: Prisma.DateTimeFilter<"RateLimit"> | Date | string
}

export type RateLimitOrderByWithRelationInput = {
  clave?: Prisma.SortOrder
  hits?: Prisma.SortOrder
  reinicia?: Prisma.SortOrder
}
...
export type RateLimitScalarWhereWithAggregatesInput = {
  ...
  clave?: Prisma.StringWithAggregatesFilter<"RateLimit"> | string
  hits?: Prisma.IntWithAggregatesFilter<"RateLimit"> | number
  reinicia?: Prisma.DateTimeWithAggregatesFilter<"RateLimit"> | Date | string
}

export type RateLimitCreateInput = {
  clave: string
  hits?: number
  reinicia: Date | string
}
...
export type RateLimitUpdateInput = {
  ...
  reinicia?: Prisma.DateTimeFieldUpdateOperationsInput | Date | string
}
...
export type RateLimitOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"clave" | "hits" | "reinicia", ExtArgs["result"]["rateLimit"]>
...
export interface RateLimitDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const rateLimitWithClaveOnly = await prisma.rateLimit.findMany({ select: { clave: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many RateLimits and only return the `clave`
   * const rateLimitWithClaveOnly = await prisma.rateLimit.createManyAndReturn({
   *   select: { clave: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more RateLimits and only return the `clave`
   * const rateLimitWithClaveOnly = await prisma.rateLimit.updateManyAndReturn({
   *   select: { clave: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface RateLimitFieldRefs {
  readonly clave: Prisma.FieldRef<"RateLimit", 'String'>
  readonly hits: Prisma.FieldRef<"RateLimit", 'Int'>
  readonly reinicia: Prisma.FieldRef<"RateLimit", 'DateTime'>
}
