...
export type ConfigWhereInput = {
  ...
  clave?: Prisma.StringFilter<"Config"> | string
  valor?: Prisma.JsonFilter<"Config">
}
...
export type ConfigScalarWhereWithAggregatesInput = {
  ...
  clave?: Prisma.StringWithAggregatesFilter<"Config"> | string
  valor?: Prisma.JsonWithAggregatesFilter<"Config">
}
...
export type ConfigOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"clave" | "valor", ExtArgs["result"]["config"]>
...
export interface ConfigDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const configWithClaveOnly = await prisma.config.findMany({ select: { clave: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Configs and only return the `clave`
   * const configWithClaveOnly = await prisma.config.createManyAndReturn({
   *   select: { clave: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Configs and only return the `clave`
   * const configWithClaveOnly = await prisma.config.updateManyAndReturn({
   *   select: { clave: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ConfigFieldRefs {
  readonly clave: Prisma.FieldRef<"Config", 'String'>
  readonly valor: Prisma.FieldRef<"Config", 'Json'>
}
